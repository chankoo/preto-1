        ...
        for i in range(num_assignments):
            ...
            if last_dept_id and random.random() < 0.70:
                ...
                if last_dept_info['DIVISION_NAME']:
                    div_members_df = department_df[department_df['UP_DEP_ID'].isin(department_df[department_df['DEP_NAME'] == last_dept_info['DIVISION_NAME']]['DEP_ID'])]
                    if not div_members_df.empty: candidate_depts = div_members_df
